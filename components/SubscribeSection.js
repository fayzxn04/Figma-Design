...
export default function Subscribe() {
  return (
    <section className="relative bg-[#e0e7ff] rounded-2xl px-6 sm:px-10 lg:px-32 py-16 mt-20 max-w-7xl mx-auto">
      {/* Paper plane */}
      <div className="absolute -top-[10px] -right-[18px] bg-[#4f46e5] p-3 rounded-full shadow-lg z-10 ">
      ...
      <div className="flex flex-col items-center text-center ">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center gap-4 w-full max-w-xl">
          ...
          <button className="bg-gradient-to-r from-orange-400 to-orange-500 text-white px-6 py-3 rounded-md shadow hover:opacity-90 transition duration-200">
            Subscribe
          </button>
        </div>
      </div>
