...
export default function About() {
  return (
    <section>
      <h4 className="text-black uppercase flex justify-center items-center text-2xl px-6 mt-20">
        Category
      </h4>
      ...
      <container className="flex flex-col sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 px-4 sm:px-10 lg:px-32 py-10">
        ...
        <div className="flex flex-col justify-center items-center ">
          <Image src="/plane.jpg" alt="Plane" height="50" width="50" />
